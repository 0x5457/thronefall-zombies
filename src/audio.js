...
export const EFFECTS = {
  ...
  dash: [['noise',1500,0,.12,.06],['triangle',330,0,.16,.05,520]],
  flare: [['noise',900,0,.5,.09],['square',660,.02,.22,.05,980],['triangle',220,.1,.7,.05,180]],
  heal: [['triangle',660,0,.18,.07],['triangle',880,.12,.24,.07],['triangle',1174,.28,.34,.06]],
